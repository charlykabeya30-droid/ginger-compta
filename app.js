...
function App() {
  ...
  const stockByProduct = useMemo(() => {
    ...
    productions.forEach(pr => {
      if (map[pr.productId] !== undefined) map[pr.productId] += pr.qty;
    });
    sales.forEach(s => {
      if (map[s.productId] !== undefined) map[s.productId] -= s.qty;
    });
  ...
  if (!auth) return /*#__PURE__*/_jsxDEV(LoginScreen, {
    onLogin: n => {
      setUserName(n);
      setAuth(true);
    }
  ...
  const addProduction = pr => {
    ...
    if (pr.cout > 0) addExpense({
      id: pr.id + 1,
      category: "Production",
      amount: pr.cout,
      comment: `Production ${pr.qty} unités — ${pr.productName}`,
      date: pr.date,
      time: pr.time,
  ...
  const editProduction = (id, updates) => setProductions(p => p.map(x => x.id === id ? {
    ...x,
    ...updates
  } : x));
  ...
  const editProduct = (id, updates) => setProducts(p => p.map(x => x.id === id ? {
    ...x,
    ...updates
  } : x));
  const NAV = [{
  ...
  const renderPage = () => {
    if (sub === "vente") return /*#__PURE__*/_jsxDEV(VentePage, {
      products: products,
      stockByProduct: stockByProduct,
      onSave: addSale,
      onBack: () => setSub(null)
    }, void 0, false);
    if (sub === "depense") return /*#__PURE__*/_jsxDEV(DepensePage, {
      onSave: addExpense,
      onBack: () => setSub(null)
    }, void 0, false);
    if (sub === "production") return /*#__PURE__*/_jsxDEV(ProductionPage, {
      products: products,
      onSave: addProduction,
      onBack: () => setSub(null)
    }, void 0, false);
    if (sub === "addProduct") return /*#__PURE__*/_jsxDEV(AddProductPage, {
      onSave: p => {
        addProduct(p);
        setSub(null);
      },
    ...
    switch (tab) {
      ...
      case "ventes":
        return /*#__PURE__*/_jsxDEV(VentesPage, {
          products: products,
          sales: sales,
          onNew: () => setSub("vente"),
          onDelete: delSale
      ...
      case "stock":
        return /*#__PURE__*/_jsxDEV(StockPage, {
          products: products,
          productions: productions,
          sales: sales,
          stockByProduct: stockByProduct,
          onNew: () => setSub("production"),
          onDelete: delProduction,
          onEdit: editProduction,
          onAddProduct: () => setSub("addProduct"),
          onDeleteProduct: delProduct,
          onEditProduct: editProduct
        }, void 0, false);
      case "rapports":
        return /*#__PURE__*/_jsxDEV(RapportsPage, {
          products: products,
          sales: sales,
          expenses: expenses,
          productions: productions
      ...
      case "params":
        return /*#__PURE__*/_jsxDEV(ParamsPage, {
          userName: userName,
  ...
  return /*#__PURE__*/_jsxDEV(_Fragment, {
    children: [/*#__PURE__*/_jsxDEV("style", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "page",
        children: renderPage()
      }, void 0, false), !sub && /*#__PURE__*/_jsxDEV("nav", {
        ...
        children: NAV.map(({
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: /*#__PURE__*/_jsxDEV(Icon, {
              size: 20,
              color: tab === key ? "var(--orange)" : "var(--text3)",
              strokeWidth: tab === key ? 2.5 : 2
            }, void 0, false)
...
function LoginScreen({
  ...
  const handle = () => {
    if (pass === "1234") onLogin(user.trim() || "Charly");else setErr("Mot de passe incorrect — essaie 1234");
  };
  return /*#__PURE__*/_jsxDEV(_Fragment, {
    children: [/*#__PURE__*/_jsxDEV("style", {
      children: CSS
    }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
      className: "login-page fade-up",
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          ...
          children: [/*#__PURE__*/_jsxDEV("input", {
            ...
            className: "lf-eye",
            onClick: () => setShow(s => !s),
            children: show ? /*#__PURE__*/_jsxDEV(EyeOff, {
              size: 18
...
function Dashboard({
  ...
  const dayTotals = {};
  sales.forEach(s => {
    const d = DAYS_FR[new Date(s.date).getDay()];
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("h2", {
        ...
        children: [/*#__PURE__*/_jsxDEV("span", {
          ...
          style: {
            fontSize: 44,
            filter: "drop-shadow(0 4px 12px rgba(255,152,0,.3))",
      ...
      className: "hero-card s1 fade-up",
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "hero-label",
        children: "Ventes du jour"
      }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
        className: "hero-amount",
        children: fmt(venteJour)
      }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
        style: {
          fontSize: 13,
          fontWeight: 600,
        ...
        children: [bottlesSold, " bouteille", bottlesSold > 1 ? "s" : "", " vendues"]
      }, void 0, true), trendPct !== null && /*#__PURE__*/_jsxDEV("div", {
        className: "hero-trend",
        children: [trendUp ? /*#__PURE__*/_jsxDEV(TrendingUp, {
          size: 13
        }, void 0, false) : /*#__PURE__*/_jsxDEV(TrendingDown, {
          size: 13
        }, void 0, false), trendUp ? "+" : "", trendPct, "% vs hier"]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "hero-ring",
        children: [/*#__PURE__*/_jsxDEV("div", {
          style: {
          ...
          children: [/*#__PURE__*/_jsxDEV("svg", {
            ...
            children: [/*#__PURE__*/_jsxDEV("circle", {
              ...
              strokeDashoffset: CIRC * (1 - progPct / 100),
              strokeLinecap: "round",
              style: {
                transition: "stroke-dashoffset .8s cubic-bezier(.34,1,.64,1)"
              }
            }, void 0, false)]
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            className: "ring-text",
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          className: "kpi-val",
          style: {
            color: benef >= 0 ? "var(--success)" : "var(--error)"
          },
          children: fmt(benef)
        }, void 0, false), trendPct !== null && /*#__PURE__*/_jsxDEV("div", {
          className: "kpi-badge",
          style: {
            background: trendUp ? "var(--success-bg)" : "var(--error-bg)",
          ...
          children: [trendUp ? /*#__PURE__*/_jsxDEV(TrendingUp, {
            ...
            size: 9
          }, void 0, false), " ", Math.abs(trendPct), "%"]
        }, void 0, true)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "kpi-card s4 fade-up",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "kpi-icon-wrap",
          style: {
          ...
          children: fmt(depJour)
        }, void 0, false)]
      }, void 0, true)]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      className: "objectif-card s3 fade-up",
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "obj-top",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "obj-icon-wrap",
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            className: "obj-bottles",
            children: [objectif, " bouteilles"]
          }, void 0, true)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          className: "obj-pct",
          children: [progPct, "%"]
        ...
        className: "obj-footer",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "obj-count",
          children: [/*#__PURE__*/_jsxDEV("strong", {
            children: bottlesSold
          }, void 0, false), " / ", objectif, " bouteilles"]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          className: "motivate-btn",
          children: [/*#__PURE__*/_jsxDEV(Star, {
            size: 12
          }, void 0, false), progPct < 50 ? "Courage !" : progPct < 100 ? "Garde le cap !" : "Objectif ! 🎉"]
        }, void 0, true)]
      }, void 0, true)]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      className: "sec-head",
      ...
      children: [{
        ...
        className: `action-item s${i + 1} fade-up`,
      ...
      className: "apercu-strip",
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "apercu-card",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "apercu-icon-wrap",
          children: /*#__PURE__*/_jsxDEV(Activity, {
            size: 18,
            color: "var(--orange)"
          }, void 0, false)
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "apercu-lbl",
          children: "Ventes semaine"
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "apercu-val",
          style: {
            color: "var(--orange)"
          },
          children: fmt(weekCA)
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          className: "apercu-lbl",
          children: "Bénéfice semaine"
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "apercu-val",
          style: {
            color: "var(--success)"
          },
          children: fmt(weekCA - weekExp2)
        }, void 0, false)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "apercu-card",
        children: [/*#__PURE__*/_jsxDEV("div", {
...
function VentePage({
  ...
  const handle = () => {
    ...
    const q = parseInt(qty) || 0,
      p = parseInt(prix) || 0;
    if (!productId) {
      setErr("Sélectionnez un produit.");
      return;
    }
    if (!q || !p) {
      setErr("Remplissez la quantité et le prix.");
      return;
    }
    if (q > stockDispo) {
      setErr(`Stock insuffisant ! Seulement ${stockDispo} unités disponibles.`);
      return;
    }
    const now = new Date();
    onSave({
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      className: "form-wrap",
      children: [ok && /*#__PURE__*/_jsxDEV("div", {
        className: "toast-success",
        children: [/*#__PURE__*/_jsxDEV(CheckCircle, {
          size: 18
        }, void 0, false), " Vente enregistrée — ", fmtDate(isoToday()), " à ", nowTime().slice(0, 5)]
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          children: "Produit vendu"
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "product-chips",
          children: products.map(p => /*#__PURE__*/_jsxDEV("button", {
            className: `product-chip ${productId === p.id ? "active" : ""}`,
            onClick: () => selectProduct(p),
            children: [p.emoji, " ", p.name]
          }, p.id, true))
        }, void 0, false), product && /*#__PURE__*/_jsxDEV("div", {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              className: "stock-banner-lbl",
              children: "Stock disponible"
            }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
              className: "stock-banner-val",
              children: [stockDispo, " bouteilles"]
            }, void 0, true)]
          }, void 0, true)]
        }, void 0, true)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      ...
      }, void 0, true), qty && prix && /*#__PURE__*/_jsxDEV("div", {
        className: "calc-preview scale-in",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "calc-lbl",
          children: "Total calculé automatiquement"
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "calc-amount",
          children: fmt(total)
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "calc-detail",
          children: [qty, " × ", fmt(parseInt(prix) || 0)]
        }, void 0, true)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("button", {
        className: "submit-btn",
        onClick: handle,
        disabled: !qty || !prix || !productId,
        children: "Enregistrer la vente"
      }, void 0, false), ok && /*#__PURE__*/_jsxDEV("button", {
...
function DepensePage({
  ...
  const [cat, setCat] = useState("Gingembre");
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [ok && /*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV(CheckCircle, {
          size: 18
        }, void 0, false), " Dépense enregistrée !"]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "f-field",
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          ...
          children: DEPENSE_CATS.map(c => /*#__PURE__*/_jsxDEV("option", {
            children: c
          }, c, false))
        }, void 0, false)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          ...
          className: "f-input",
          placeholder: "Ex : Achat de gingembre",
          value: comment,
          onChange: e => setComment(e.target.value)
        }, void 0, false)]
      }, void 0, true), amount && /*#__PURE__*/_jsxDEV("div", {
        className: "calc-preview scale-in",
        style: {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          className: "calc-amount",
          children: fmt(parseInt(amount) || 0)
        }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
          className: "calc-detail",
          children: cat
        }, void 0, false)]
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [ok && /*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV(CheckCircle, {
          size: 18
        }, void 0, false), " Production enregistrée ! Stock mis à jour."]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "f-field",
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          children: "Nombre d'unités produites"
        }, void 0, false), /*#__PURE__*/_jsxDEV("input", {
          className: "f-input",
          type: "number",
          placeholder: "Ex : 50",
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          children: "Coût de production (FC)"
        }, void 0, false), /*#__PURE__*/_jsxDEV("input", {
          className: "f-input",
          type: "number",
      ...
      }, void 0, true), (qty || cout) && /*#__PURE__*/_jsxDEV("div", {
        className: "calc-preview scale-in",
        style: {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "calc-lbl",
          children: ["Résumé — ", product?.name]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          className: "calc-amount",
          children: [qty || 0, " unités"]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          className: "calc-detail",
          children: ["Coût : ", fmt(parseInt(cout) || 0)]
        }, void 0, true)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("button", {
        className: "submit-btn",
        onClick: handle,
        disabled: !qty || !productId,
        children: "Enregistrer la production"
      }, void 0, false), ok && /*#__PURE__*/_jsxDEV("button", {
        className: "back-dash-btn",
        onClick: onBack,
        children: "← Retour"
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [ok && /*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV(CheckCircle, {
          size: 18
        }, void 0, false), " Produit créé avec succès !"]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "f-field",
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          ...
          children: EMOJIS.map(e => /*#__PURE__*/_jsxDEV("button", {
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          ...
          className: "f-input",
          placeholder: "Ex : Jus de bissap, Café glacé...",
          value: name,
        ...
        children: [/*#__PURE__*/_jsxDEV("label", {
          className: "f-label",
          children: "Prix de vente par défaut (FC)"
        }, void 0, false), /*#__PURE__*/_jsxDEV("input", {
          className: "f-input",
          type: "number",
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV(Plus, {
          size: 14
        }, void 0, false), " Nouvelle"]
      }, void 0, true)]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      className: "hist-filter",
      children: [/*#__PURE__*/_jsxDEV("input", {
        className: "hist-date-in",
        type: "date",
        value: filter,
        onChange: e => setFilter(e.target.value)
      }, void 0, false), filter && /*#__PURE__*/_jsxDEV("button", {
        className: "clear-btn",
        onClick: () => setFilter(""),
        children: "✕"
      }, void 0, false)]
    }, void 0, true), dates.length === 0 && /*#__PURE__*/_jsxDEV("div", {
      className: "empty",
      children: "Aucune vente enregistrée"
    }, void 0, false), dates.map(date => /*#__PURE__*/_jsxDEV("div", {
      className: "day-block",
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "day-badge",
        children: [/*#__PURE__*/_jsxDEV(Calendar, {
          size: 12
        }, void 0, false), " ", fmtDate(date)]
      }, void 0, true), groups[date].map(s => /*#__PURE__*/_jsxDEV("div", {
        className: "hist-row",
        children: [/*#__PURE__*/_jsxDEV("div", {
          children: [/*#__PURE__*/_jsxDEV("span", {
            className: "hist-pill vente",
            children: "Vente"
          }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
            className: "hist-desc",
            children: [s.productEmoji || "🧃", " ", s.productName || "Produit", " · ", s.qty, " unité(s) × ", fmt(s.prix)]
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            className: "hist-time",
          ...
          children: [/*#__PURE__*/_jsxDEV("span", {
            className: "hist-amt pos",
            children: ["+", fmt(s.total)]
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            className: "hist-actions",
            children: /*#__PURE__*/_jsxDEV("button", {
              className: "icon-btn del",
              onClick: () => {
                if (window.confirm("Supprimer cette vente ?")) onDelete(s.id);
              },
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV(Plus, {
          size: 14
        }, void 0, false), " Produire"]
      }, void 0, true)]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      className: "stock-hero",
      children: [/*#__PURE__*/_jsxDEV("div", {
        style: {
          fontSize: 11,
          fontWeight: 700,
        ...
        className: "stock-hero-num",
        children: totalStock
      }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
        className: "stock-hero-lbl",
        children: ["bouteilles disponibles — ", products.length, " produit(s)"]
      }, void 0, true)]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      className: "sec-head",
      children: [/*#__PURE__*/_jsxDEV("span", {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: [/*#__PURE__*/_jsxDEV("div", {
                ...
                style: {
                  color: st === 0 ? "var(--error)" : st < 5 ? "var(--orange)" : "var(--text2)"
                },
                children: st === 0 ? "⚠ Rupture de stock" : `${st} unités dispo`
              }, void 0, false), isEditingPrice ? /*#__PURE__*/_jsxDEV("div", {
                style: {
                  display: "flex",
                  alignItems: "center",
                  gap: 6,
                ...
                children: [fmt(p.prix), " ", /*#__PURE__*/_jsxDEV(Pencil, {
                  size: 11,
                  style: {
            ...
            children: /*#__PURE__*/_jsxDEV("button", {
              className: "icon-btn del",
              onClick: () => {
                if (window.confirm(`Supprimer "${p.name}" ?`)) onDeleteProduct(p.id);
              },
              style: {
                marginLeft: "auto"
              },
      ...
      children: /*#__PURE__*/_jsxDEV("span", {
        className: "sec-title",
        children: "Historique des productions"
      }, void 0, false)
    }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
      style: {
        padding: "0 24px"
      },
      children: [productions.length === 0 && /*#__PURE__*/_jsxDEV("div", {
        className: "empty",
        children: "Aucune production"
      }, void 0, false), productions.slice(0, 30).map(pr => /*#__PURE__*/_jsxDEV("div", {
        className: "hist-row",
        children: [/*#__PURE__*/_jsxDEV("div", {
          children: [/*#__PURE__*/_jsxDEV("span", {
            className: "hist-pill production",
            children: "Production"
          }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
            className: "hist-desc",
            children: [pr.productEmoji || "📦", " ", pr.productName || "Produit", " · ", pr.qty, " unités · ", fmtDate(pr.date)]
          }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
            className: "hist-time",
            children: [/*#__PURE__*/_jsxDEV(Clock, {
              size: 10
            }, void 0, false), " ", pr.time, " · Coût : ", fmt(pr.cout || 0)]
          }, void 0, true)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          className: "hist-actions",
          children: [/*#__PURE__*/_jsxDEV("button", {
            className: "icon-btn edit",
            onClick: () => setEditModal(pr),
            ...
            className: "icon-btn del",
            onClick: () => {
              if (window.confirm("Supprimer cette production ?")) onDelete(pr.id);
            },
            children: /*#__PURE__*/_jsxDEV(Trash2, {
              size: 13,
              color: "var(--error)"
    ...
    }, void 0, false), editModal && /*#__PURE__*/_jsxDEV(EditProductionModal, {
      production: editModal,
      onSave: updates => {
        onEdit(editModal.id, updates);
        setEditModal(null);
      },
    ...
    children: /*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          children: "Modifier la production"
        }, void 0, false), /*#__PURE__*/_jsxDEV("button", {
        ...
        children: [/*#__PURE__*/_jsxDEV("span", {
          ...
          children: production.productEmoji || "📦"
        }, void 0, false), /*#__PURE__*/_jsxDEV("span", {
          style: {
            fontSize: 14,
            fontWeight: 700,
          ...
          children: production.productName
        }, void 0, false)]
      }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
        className: "f-field",
        children: [/*#__PURE__*/_jsxDEV("label", {
        ...
        }, void 0, false), " Sauvegarder les modifications"]
      }, void 0, true)]
    }, void 0, true)
  }, void 0, false);
}
...
function RapportsPage({
  ...
  const byProduct = useMemo(() => {
    ...
    fSalesAll.forEach(s => {
      if (map[s.productId]) {
        map[s.productId].ca += s.total;
        map[s.productId].qty += s.qty;
      }
    });
    fProdAll.forEach(p => {
      if (map[p.productId]) map[p.productId].cout += p.cout || 0;
    });
  ...
  const chartData = useMemo(() => {
    ...
    for (let i = 6; i >= 0; i--) {
      ...
      days.push({
        name: lbl,
        Ventes: daySales.reduce((s, x) => s + x.total, 0),
        Dépenses: dayExp.reduce((s, x) => s + x.amount, 0)
      });
    }
    return days;
  ...
  return /*#__PURE__*/_jsxDEV("div", {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [["jour", "Aujourd'hui"], ["semaine", "Semaine"], ["mois", "Mois"], ["annee", "Année"]].map(([k, l]) => /*#__PURE__*/_jsxDEV("button", {
        className: `period-pill ${period === k ? "active" : ""}`,
        onClick: () => setPeriod(k),
        children: l
      }, k, false))
    }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("button", {
        className: `prod-tab ${prodFilter === "all" ? "active" : ""}`,
        onClick: () => setProdFilter("all"),
        children: [/*#__PURE__*/_jsxDEV(BarChart2, {
          size: 12
        }, void 0, false), " Tous les produits"]
      }, void 0, true), products.map(p => /*#__PURE__*/_jsxDEV("button", {
        className: `prod-tab ${prodFilter === p.id ? "active" : ""}`,
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: prodFilter === "all" ? "Tous les produits" : products.find(p => p.id === prodFilter)?.name || ""
      }, void 0, false), [{
        Icon: Factory,
        ...
        label: "Bénéfice net",
        val: fmt(ben),
        color: ben >= 0 ? "var(--success)" : "var(--error)",
        bg: ben >= 0 ? "var(--success-bg)" : "var(--error-bg)"
      }].map(({
        Icon,
        label,
        val,
    ...
    }, void 0, true), prodFilter === "all" && /*#__PURE__*/_jsxDEV("div", {
      className: "report-card",
      children: [/*#__PURE__*/_jsxDEV("div", {
        className: "report-card-title",
        children: "Ventilation par produit"
      }, void 0, false), byProduct.map(p => /*#__PURE__*/_jsxDEV("div", {
        className: "rep-row",
        children: [/*#__PURE__*/_jsxDEV("div", {
          className: "rep-left",
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              children: [p.qty, " ventes · coût ", fmt(p.cout)]
            }, void 0, true)]
          }, void 0, true)]
        }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
          style: {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            ...
            style: {
              fontSize: 11,
              fontWeight: 700,
              color: p.ca - p.cout >= 0 ? "var(--success)" : "var(--error)"
            },
            children: [p.ca - p.cout >= 0 ? "+" : "", fmt(p.ca - p.cout)]
          }, void 0, true)]
        }, void 0, true)]
      }, p.name, true))]
    }, void 0, true), /*#__PURE__*/_jsxDEV("div", {
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
        ...
        children: [/*#__PURE__*/_jsxDEV("span", {
          ...
          children: "Ventes & Dépenses"
        }, void 0, false), /*#__PURE__*/_jsxDEV("span", {
          className: "chart-sub",
          children: "7 derniers jours"
        }, void 0, false)]
      }, void 0, true), chartData.some(d => d.Ventes > 0 || d.Dépenses > 0) ? /*#__PURE__*/_jsxDEV(ResponsiveContainer, {
        width: "100%",
        height: 200,
      ...
      children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      }, void 0, true), chartData.some(d => d.Ventes > 0) ? /*#__PURE__*/_jsxDEV(ResponsiveContainer, {
        width: "100%",
        height: 200,
        children: /*#__PURE__*/_jsxDEV(AreaChart, {
          ...
          }, void 0, false), /*#__PURE__*/_jsxDEV(CartesianGrid, {
            strokeDasharray: "3 3",
            stroke: "var(--border)",
            vertical: false
          }, void 0, false), /*#__PURE__*/_jsxDEV(XAxis, {
    ...
    children: [/*#__PURE__*/_jsxDEV("div", {
      ...
      children: [saved && /*#__PURE__*/_jsxDEV("div", {
        ...
        children: /*#__PURE__*/_jsxDEV("div", {
          ...
          children: [/*#__PURE__*/_jsxDEV(CheckCircle, {
            size: 18
          }, void 0, false), " Paramètres sauvegardés !"]
        }, void 0, true)
      }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
        style: {
          marginBottom: 20
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            children: [/*#__PURE__*/_jsxDEV("div", {
              ...
              className: "param-sub",
              children: "Affiché sur l'accueil"
            }, void 0, false)]
        ...
        children: [/*#__PURE__*/_jsxDEV("div", {
          ...
          children: [/*#__PURE__*/_jsxDEV("div", {
            children: [/*#__PURE__*/_jsxDEV("div", {
              className: "param-label",
              children: "Objectif quotidien"
            }, void 0, false), /*#__PURE__*/_jsxDEV("div", {
              className: "param-sub",
              children: "Unités à vendre par jour"
            }, void 0, false)]
          }, void 0, true), /*#__PURE__*/_jsxDEV("input", {
            className: "param-val-input",
            type: "number",
